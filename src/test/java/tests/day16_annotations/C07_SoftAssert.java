...
public class C07_SoftAssert extends TestBase {
    ...
    public void test01() {
        ...
        WebElement loginKutusuElementi = driver.findElement(By.xpath("//input[@name='user_login']"));
        ...
        softAssert.assertEquals(selectedOption,expectedOption,"secilen option uygun degil");
